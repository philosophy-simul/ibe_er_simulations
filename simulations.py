...
if __name__ == "__main__":
    ...
    for ntosses in ntosses_list:
        ...
        plot_results(results, partitioning, thresholds, bias_lower, bias_upper, rule_labels, output_dir, ntosses)
        plot_mean_std(results, partitioning, bias_lower, bias_upper, rule_labels, marker_styles, output_dir, ntosses)
        export_results_to_csv(results, partitioning, thresholds, bias_lower, bias_upper, rule_labels, ntosses)
